# HHVDoctorSDK 接入说明
   * [HHVDoctorSDK 接入说明](#hhvdoctorsdk-接入说明)
      * [0. 更新日志](#0-更新日志)
      * [1. 集成方式](#1-集成方式)
         * [1.1. 自动集成](#11-自动集成)
         * [1.2. 调用规则](#12-调用规则)
      ...
      * [7. 其他配置](#7-其他配置)
         * [7.1. APNs](#71-apns)
         * [7.2. Background Modes](#72-background-modes)
      * [问题说明](#问题说明)
...
### 1.2. 调用规则
所有 HHVDoctorSDK 业务均通过 HHMSDK 单例调用

```swift
public class HHMSDK : NSObject {

    public static let `default`: HHVDoctorSDK.HHMSDK
}
```

## 2. 初始化
在使用 HHVDoctorSDK 任何方法之前，都应该首先调用初始化方法。正常业务情况下，初始化方法有仅只应调用一次。
